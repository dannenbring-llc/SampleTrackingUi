    ...
    public class RoleStore : IRoleStore<ApplicationRole>
    {
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationRole role, CancellationToken cancellationToken)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                role.Id = await connection.QuerySingleAsync<int>($@"INSERT INTO [IST_ApplicationRole] ([Name], [NormalizedName])
        ...
        public async Task<IdentityResult> UpdateAsync(ApplicationRole role, CancellationToken cancellationToken)
        {
            ...
            {
                await connection.OpenAsync(cancellationToken);
                await connection.ExecuteAsync($@"UPDATE [IST_ApplicationRole] SET
        ...
        public async Task<IdentityResult> DeleteAsync(ApplicationRole role, CancellationToken cancellationToken)
        {
            ...
            {
                await connection.OpenAsync(cancellationToken);
                await connection.ExecuteAsync($"DELETE FROM [IST_ApplicationRole] WHERE [Id] = @{nameof(ApplicationRole.Id)}", role);
            }
        ...
        public async Task<ApplicationRole> FindByIdAsync(string roleId, CancellationToken cancellationToken)
        {
            ...
            {
                await connection.OpenAsync(cancellationToken);
                return await connection.QuerySingleOrDefaultAsync<ApplicationRole>($@"SELECT * FROM [IST_ApplicationRole]
